...
function loadDoc() {
    ...
    fetch(endpoint)
        ...
        .then(data => {
            ...
            var tableheader = '<div class="table-wrapper-scroll-y my-custom-scrollbar">\n' +
                '\n' +
                '  <table class="table table-bordered table-striped mb-0">\n' +
                '    <thead>\n' +
                '      <tr>'; // this is the table header .. just take it
            tableheader += ' <th scope="col">Title</th>\n' +
            ...
            var tableclosing = " </tbody>\n" +
                "  </table>\n" +
                "\n" +
                "</div>\n"; // the table end just take it
            var fulltext = tableheader + tabletext + tableclosing;
            //
            // save the full text as innerHTML of the popup element named showwindowData
            document.getElementById('showwindowData').innerHTML = fulltext;
